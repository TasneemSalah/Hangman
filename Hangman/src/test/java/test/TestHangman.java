...
class TestHangman {
	...
	/**
	 * tests that fetchClue returns string with all dashes of same length as word
	 * passed to fetchClue()
	 */
	@Test
	...
	/**
	 * tests that fetchClue returns string with dashes replaced with correct guessed
	 * character passed to fetchClue()
	 */
	@Test
	...
	/**
	 * tests that fetchClue returns string with no dashes replaced with incorrect
	 * guessed character passed to fetchClue()
	 */
	@Test
	...
	void test_saveScoreUsingMockDB() {
		MockScoreDB mockObject = mock(MockScoreDB.class);
		Hangman hangman = new Hangman(mockObject);
		when(mockObject.writeScoreDB("apple", 10)).thenReturn(true);
